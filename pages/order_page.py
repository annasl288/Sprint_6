...
class OrderPage(BasePage):
    ...
    def fill_out_form_about_user(self, user):
        self.driver.find_element(*self.NAME).send_keys(user['name'])
        self.driver.find_element(*self.SURNAME).send_keys(user['surname'])
        self.driver.find_element(*self.ADDRESS).send_keys(user['address'])
        self.driver.find_element(*self.METRO).click()
        self.driver.find_element(*self.METRO).send_keys(user['metro'])
    ...
    def fill_out_form_about_rent(self, user):
        self.driver.find_element(*self.DATE).send_keys(user['date'])
        self.driver.find_element(*self.PICK_DATE).click()
        self.driver.find_element(*self.DAYS).click()
        self.driver.find_element(*self.RENT_THREE_DAYS).click()
